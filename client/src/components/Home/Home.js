      ...
      <MediaQuery minDeviceWidth={1280}>
        <div className='Home'>
          ...
          <div className='Center'>
            ...
            <h4>
              אנחנו בקבוצת מקס - פיט מאמינים שפעילות מהנה יותר, היא גם יעילה
              יותר ותורמת לחיים מאושרים יותר.
            </h4>
          </div>
          <Boxflex />
          ...
          <div className='Center'>
            <h4>
              האידיאולוגיה העיקרית בה דוגלת הקבוצה, מלבד כמובן קיום וקידום של
              אורח חיים בריא, תזונה נכונה, פעילות ספורטיבית ושגרה פעילה ומהנה,
              היא עשייה של כל זאת בסטנדרטים גבוהים ובלתי מתפשרים של איכות – מרמת
              הציוד הטכני, דרך רמת המאמנים האישיים המקצועיים בשלל התחומים ועד
              למגוון רחב של פעילויות, סדנאות וחוגים שאנו מציעים לחברי המועדון
              שלנו.
            </h4>
          </div>
        </div>
